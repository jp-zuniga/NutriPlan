...
<svelte:head>
    ...
    <meta name="description" content="Planifica tu alimentación con recetas nicaragüenses adaptadas a tus necesidades y condiciones médicas" />
</svelte:head>
...
<div class="home-container">
    ...
    <section class="hero">
        <div class="hero-content">
            <h1 class="hero-title">Nutrición personalizada para <span class="highlight">nicaragüenses</span></h1>
            <p class="hero-subtitle">Planes alimenticios adaptados a tus metas, condiciones médicas y preferencias con ingredientes locales</p>
    ...
    <section class="search-section">
        <div class="container">
            ...
            <p class="search-hint">O explora nuestras <a href="/recipes">recetas con filtros avanzados</a></p>
        </div>
    </section>
                    ...
                    <div class="recipe-card">
                        ...
                        <div class="recipe-content">
                            ...
                            <div class="recipe-meta">
                                ...
                                <span class="calories">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M17.5 22c.83 0 1.5-.67 1.5-1.5V6c0-2.21-1.79-4-4-4S11 3.79 11 6v14.5c0 .83.67 1.5 1.5 1.5h5z"></path>
            ...
            <div class="testimonials-grid">
                <div class="testimonial">
                    <div class="testimonial-content">
                        <p>"Como persona con diabetes, NutriPlan me ha ayudado a mantener mis niveles de azúcar con recetas adaptadas y deliciosas."</p>
                    </div>
                ...
                <div class="testimonial">
                    <div class="testimonial-content">
                        <p>"Las recetas con ingredientes locales hacen que comer saludable sea accesible y económico para mi familia."</p>
                    </div>
                    <div class="testimonial-author">
                ...
                <div class="testimonial">
                    <div class="testimonial-content">
                        <p>"La función de receta rápida me salva cuando no sé qué cocinar con lo que tengo en la despensa."</p>
                    </div>
                    <div class="testimonial-author">
                        <strong>Ana R.</strong>
                        <span>Granada</span>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .steps, .features-grid, .recipes-grid, .testimonials-grid {
